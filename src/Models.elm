...
moviesCollection = [avengers2, toyStory3, lionKing, it, shutterIsland]
...
shutterIsland : Movie
shutterIsland = {id= 5, poster= createPoster "./Assets/Shutter_Island.png", title= "Shutter Island", rating= 8.1, genre= ["Thriller"], link= "https://www.youtube.com/watch?v=YDGldPitxic", likes = 0, matchPercentage = 0, forKids = False, actors = ["Leonardo DiCaprio", "Mark Ruffalo", "Ben Kingsley", "Michelle Williams", "Patricia Clarkson"]}
